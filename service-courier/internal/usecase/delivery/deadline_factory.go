...
// GetDeliveryCalculator фабрика для работы с временем доставки
func (f Factory) GetDeliveryCalculator(courierType model.CourierTransportType) DeadlineCalculator {
	switch courierType {
