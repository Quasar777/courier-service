...
func (m *MockDeliveryRepository) ReleaseCouriers(ctx context.Context) error {
	m.ctrl.T.Helper()
...
func (mr *MockDeliveryRepositoryMockRecorder) ReleaseCouriers(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReleaseCouriers", reflect.TypeOf((*MockDeliveryRepository)(nil).ReleaseCouriers), ctx)
}
